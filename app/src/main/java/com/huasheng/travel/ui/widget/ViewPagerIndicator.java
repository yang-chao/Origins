...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 默认的指示器颜色
     */
    private int COLOR_DEFAULT_INDICATOR = 0xFFFFFFFF;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mTabVisibleCount = a.getInt(R.styleable.ViewPagerIndicator_item_count,
                COUNT_DEFAULT_TAB);
        int mIndicatorColor = a.getColor(R.styleable.ViewPagerIndicator_indicator_color, COLOR_DEFAULT_INDICATOR);
    ...
    public void setIndicatorColor(int color) {
        COLOR_DEFAULT_INDICATOR = color;
        if (mPaint != null){
            mPaint.setColor(COLOR_DEFAULT_INDICATOR);
            postInvalidate();
        }
    }
     ...
     * @param color
     */
    public void setHighLightColor(int color, int position) {
        COLOR_TEXT_HIGHLIGHTCOLOR = color;
     ...
     */
    public void setNormalColor(int color, int position) {

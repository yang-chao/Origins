...
public class PreferenceManager {
	...
	private static String SHARED_KEY_CURRENTUSER_LEVEL = "SHARED_KEY_CURRENTUSER_LEVEL";
	...
	public void setCurrentUserLevel(int level) {
		editor.putInt(SHARED_KEY_CURRENTUSER_LEVEL, level);
		editor.commit();
	}
	...
	public int getCurrentUserLevel() {
		return mSharedPreferences.getInt(SHARED_KEY_CURRENTUSER_LEVEL, 0);
	}

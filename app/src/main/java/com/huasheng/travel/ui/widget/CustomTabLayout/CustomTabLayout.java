...
package com.huasheng.travel.ui.widget.CustomTabLayout;
...
import com.huasheng.travel.core.util.DensityUtils;

import static android.support.v4.view.ViewPager.SCROLL_STATE_DRAGGING;
import static android.support.v4.view.ViewPager.SCROLL_STATE_IDLE;
import static android.support.v4.view.ViewPager.SCROLL_STATE_SETTLING;
import static com.huasheng.travel.core.util.SysUtils.getScreenWidth;
...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    public void setSlidingTabStripPadding(int padding) {
        mTabStrip.setSlidingTabStripPadding(padding);
    }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int mSlidingTabStripPadding;
        ...
        void setSlidingTabStripPadding(int padding) {
            if (mSlidingTabStripPadding != padding) {
                mSlidingTabStripPadding = padding;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft+mSlidingTabStripPadding, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight-mSlidingTabStripPadding, getHeight(), mSelectedIndicatorPaint);
            }
        }
    }

 ...
 */
public class MyVideoView extends SurfaceView implements CustomMediaController.MediaPlayerControl {
...
//            }
            ...
            // simply make mCanPause|mCanSeekBack|mCanSeekForward = true
            mCanPause = true;
            mCanSeekBack = true;
...
//    }
    ...
    public void setForceFullscreen(boolean force) {
        mForceFullscreen = force;
    }
...
//                    (View)this.getParent() : this;
    ...
    /**
     * Register a callback to be invoked when an seek event
     * occurs.
     *
     * @param seekCompleteListener
     */
    public void setOnSeekCompletedListener(OnSeekCompleteListener seekCompleteListener) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_DOWN && mPressDownTime != downtime) {
            mPressDownTime = downtime;
            if (isInPlaybackState() && mMediaController != null) {
                toggleMediaControlsVisiblity();
            }
        }
        return true; // 消费点击事件，防止传递到上层view
    }
    ...
    public void switchMute() {
        if (mAudioManager != null) {
            if (!isSilentMode()) {
                ...
                mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, mVolumeNotMute > 0 ? mVolumeNotMute : 0, AudioManager.FLAG_PLAY_SOUND);
            }
        }
    }
    ...
    public void setTouchEnable(boolean enbale) {
        mIsTouchEnable = enbale;
    }
}

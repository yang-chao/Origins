...
public class ModelUtils {
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> cursor2MapList(Cursor cursor,
			String[] nameAlias) {
		...
		for (int i = 0; i < count; i++) {
			...
			keys[i] = nameAlias == null || TextUtils.isEmpty(nameAlias[i]) ? columnNames[i]
					: nameAlias[i];
		}
		...
		do {
			...
			for (int i = 0; i < count; i++) {
				...
				if (BaseColumns._ID.equals(name)) {
					item.put(key, cursor.getLong(indexs[i]));
				} else {
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> cursor2MapListWithoutDuplicatedByKey(
			Cursor cursor, String[] nameAlias, String keyName) {
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
					...
					if (map.containsKey(key)) {
						...
						if (o instanceof Map) {
							...
							for (int i = 0; i < length; i++) {
								array.put(map2Json((Map<String, Object>) list
										.get(i)));
							}
	 ...
	 * @return
	 */
	public static Map<String, Object> getMapValue(Map<String, Object> map,
			String key) {
		Object o = getValue(map, key);
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> getListMapValue(
	 ...
	 * @param value
	 */
	public static void putMapValue(Map<String, Object> map, String key,
			Object value) {
		if (map == null || TextUtils.isEmpty(key)) {
			return;
		}
